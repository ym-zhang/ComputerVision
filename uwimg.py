...
nn_interpolate = lib.nn_interpolate
nn_interpolate.argtypes = [IMAGE, c_float, c_float, c_int]
nn_interpolate.restype = c_float
...
spherical_project = lib.spherical_project
